...
namespace Q1.Models
{
    public partial class SPRING_24_B1Context : DbContext
    {
        public SPRING_24_B1Context()
        {
        }

        public SPRING_24_B1Context(DbContextOptions<SPRING_24_B1Context> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EmployeeProject>(entity =>
            {
                entity.HasKey(e => new { e.EmployeeId, e.ProjectId })
                    .HasName("PK__Employee__6DB1E41C7115CB83");
            ...
            modelBuilder.Entity<EmployeeSkill>(entity =>
            {
                entity.HasKey(e => new { e.EmployeeId, e.SkillId })
                    .HasName("PK__Employee__172A46EF2C8691C6");
